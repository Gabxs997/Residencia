            ...
            <table class="scrollable-table" id="partidasTable">
                <thead>
                    <tr>
                        ...
                        <th>Partida Contable (subpartida)</th>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="acciones">
                                <a href="../actions/editarPartida.php?id=<?= $row['id'] ?>" class="btn-editar">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <a href="#" class="btn-eliminar" onclick="validar('../actions/eliminar.php?tabla=partidas&id=<?= $row['id'] ?>')">

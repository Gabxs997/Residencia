...
<header class="headerPanel">
    ...
    <div class="sections">
        <ul>
            <li><a href="tablas/tablaArticulos.php">Artículos</a></li>
            <li><a href="tablas/tablaProveedores.php">Proveedores</a></li>
            <li><a href="tablas/tablaPartidas.php">Partidas</a></li>
            <li><a href="tablas/tablaUbicaciones.php">Áreas</a></li>
        </ul>
    </div>
</main>
